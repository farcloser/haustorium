...
Recordings with no silent passages literally have no segment we can measure noise floor properly.
Experimental records, or darker music, will have purposely sonic properties
that will be construed as noise.

A high noise floor indication should be taken with a grain of salt, and confirmed with
